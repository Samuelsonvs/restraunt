		...
		<div className="container">
			<div className="row">
				...
				<div className="col-lg-3 col-md-6">
					...
					<p className="lead">Street, Street, Street, 5555</p>
					<p className="lead"><a href="#">+90 555 555 55 55</a></p>
					<p><a href="#"> msa@admin.com</a></p>
				</div>
				<div className="col-lg-3 col-md-6">
					<h3>Subscribe</h3>
					...
					<ul className="list-inline f-social">
						...
						<li className="list-inline-item"><a href="#"><i className="fa fa-youtube" aria-hidden="true"></i></a></li>
			...
			<div className="container">
				<div className="row">
					<div className="col-lg-12">
						<p className="company-name">All Rights Reserved. &copy; 2020 <a href="#">Hamsiye Restorant</a> Design By :
					<a href="#top">MSA</a></p>
					</div>
				</div>
			</div>
